    ...
    <div class="col-xlg-8 col-md-12">
      <!-- boton formulario-->
                ...
                <div class="example">
                  ...
                  type="button"><i class="site-menu-icon wb-add-file" aria-hidden="true"></i>Generar Codigos</button>
                  <!-- Modal -->
                  ...
                  role="dialog" tabindex="-1">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleFormModalLabel" align="center" style="background-color: white; border: white;">Generar Codigos</h4>
