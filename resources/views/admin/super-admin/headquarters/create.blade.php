<div class="modal fade" id="headquarterModal" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
role="dialog" tabindex="-1">
<div class="modal-dialog">

    {!! Form::open(array('url' => 'control/veterinary/add/headquarter/'.Crypt::encrypt($veterinary->id), 'method' => 'POST', 'class' => 'modal-content', 'id' => 'form-veterinary')) !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">×</span>
      </button>
      <span class="input-group-addon" style="background-color: white; border: white;">
      <h4 class="modal-title" id="exampleFormModalLabel" align="center" style="background-color: white; border: white;">Nueva Sede</h4>
      </span>
    </div>
