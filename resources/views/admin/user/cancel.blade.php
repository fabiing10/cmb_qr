<div class="modal fade" id="cancelAppoiment" aria-hidden="false" aria-labelledby="exampleFormModalLabel" role="dialog" tabindex="-1">
  <div class="modal-dialog" style="background-color: white;">
    <div class="modal-body">
          ...
          <div class="row">
            {!! Form::open(array('url' => 'user/appointments/cancel', 'method' => 'POST', 'class' => 'modal-content')) !!}
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="exampleFormModalLabel" align="center" style="background-color: white; border: white;">Caancelar Cita</h4>
              </span>
            </div>
            <div class="modal-body">
              <div class="row">
