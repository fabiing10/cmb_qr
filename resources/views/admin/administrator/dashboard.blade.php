...
<head>
  ...
  <script type="text/javascript" src="{{URL::asset('admin/qr/js/jquery-3.0.0.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/zxing.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/camera.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/qr.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/material.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/clipboard.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/store.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/visibility.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/FileSaver.min.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('admin/qr/vue.min.js')}}"></script>
</head>
<body id="app">
