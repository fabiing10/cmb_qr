            ...
            <div class="panel-body">
              ...
              <div class="pearls row">
                <div class="pearl current col-xs-4">
                  ...
                  <span class="pearl-title">Informacion Mascota</span>
                </div>
              ...
              <form class="wizard-content" id="dataFormContainer" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="wizard-pane active" role="tabpanel">
                    <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                      <input type="text" value="{{$client->id}}" name="userOwner" hidden=""/>
                      <div class="row">
                          ...
                          <div class="col-lg-6 form-group">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="name" placeholder="Mascota">
                            </div>
                          </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row" id="characterics" style="display:none;">
                          ...
                          <div class="col-lg-6 form-group">
                            <div class="input-group">
                              <span class="input-group-addon"></span>
                              <input type="text" class="form-control" id="color" name="color" placeholder="Color" style="display:none;">
                      ...
                      <div class="row">
                        <div class="col-lg-6 form-group">
                          <div class="input-group">
                            <span class="input-group-addon"></span>
                            <input type="number" class="form-control" name="age" placeholder="Edad (meses)">
                          </div>
                        </div>
                      </div>
                </div>
                <div class="wizard-pane" id="exampleGettingOne" role="tabpanel">
                  ...
                  <div class="row">
                      <div class="col-lg-6 form-group">
                        <div class="input-group">
                          <label class="bold">Tipo Mascota</label>
                          <span id="typePet">
      ...
      $('#dataFormContainer').formValidation({
        ...
        fields: {
          ...
          gender: {
              ...
              validators: {
                notEmpty: {
                  message: 'Digite la edad de su mascota'
                }
              }
          },image: {
              validators: {
