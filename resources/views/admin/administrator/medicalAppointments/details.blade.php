            ...
            <div class="example-wrap">
                <div class="nav-tabs-horizontal">
                  <ul class="nav nav-tabs" data-plugin="nav-tabs" role="tablist">
                    <li class="active" role="presentation"><a data-toggle="tab" href="#generalInfo" aria-controls="exampleTabsOne" role="tab" aria-expanded="false">General</a></li>
                    <li role="presentation" class=""><a data-toggle="tab" href="#clinicHistory" aria-controls="exampleTabsTwo" role="tab" aria-expanded="false">Historia Clinica</a></li>
                    <li role="presentation" class=""><a data-toggle="tab" href="#clinicHistory2" aria-controls="exampleTabsTwo" role="tab" aria-expanded="false">Historia Clinica</a></li>
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <span id="veterinary">Name Veterinary</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <span id="userVeterinary">Nombre Medico</span>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane" id="clinicHistory" role="tabpanel">
                      <div class="row">
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="form-group">
                              <label class="control-label">Turgencia Piel</label>
                              <span id="skinTugor"></span>
                            </div>
                    ...
                    <div class="tab-pane" id="clinicHistory2" role="tabpanel">
                      <div class="row">
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="form-group">
                             <label class="control-label">Sistema Cardio vascular</label>
