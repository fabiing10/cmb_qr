...
$resultado = explode(" ", $FechaHora);
 // porción1
$fecha = $resultado[0];
$hora = $resultado[1]; // porción2

$resultado2 = explode(":", $hora);
$field_hora = $resultado2[0];
$field_minutos = $resultado2[1];
$h_final = $field_hora.':'.$field_minutos;
            ...
            <div class="panel-body">
              ...
              <div class="pearls row links-hclinic">
                ...
                <div class="pearl current col-xs-2">
                  ...
                  <span class="pearl-title">Reprogramar Cita</span>
                </div>
              </div>
              <!-- End Steps -->
              <!-- Wizard Content -->
                ...
                <div class="wizard-pane active" id="paso1" role="tabpanel">
                  ...
                  <input type="hidden" name="pet" id="pet" />
                    ...
                    <div class="col-lg-12">
                        ...
                        <textarea class="form-control" name="description" rows="3" placeholder="{{$appointment->description}}" >{{$appointment->description}}</textarea>
                        </div>
                       </div>
                    </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" data-plugin="datepicker" id="dateAppointment" name="date" required="" value="{{$fecha}}">
                        </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="input-group clockpicker-wrap" data-plugin="clockpicker">
                             <input type="text" class="timepicker form-control" data-plugin="clockpicker" data-autoclose="true" name="hour" value="{{$h_final}}">
                            <span class="input-group-addon">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="veterinary" placeholder="Nombre Medico" required="" value="{{$veterinaryName}}">
                        </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="cost" placeholder="Costo consulta" required="" value="{{$costName}}">
                        </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="form-group col-lg-12 text-right padding-top-m">
                        <button type="submit" name="sendForm" id="sendForm"class="btn btn-primary" style="display:none;" id="validateButton1" style="margin: 0 auto;display: block;"><i class="icon wb-check"></i>Reprogramar Cita</button>
                      </div>
                    </div>
                </div>
              </form>
