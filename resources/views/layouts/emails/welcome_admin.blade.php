	...
	<tr>
		...
		<td class="container" align="" bgcolor="#FFFFFF">
			...
			<div class="content">
                ...
                Hola {{$name}}. Ya eres parte de la familia IdentiPET. Ha sido seleccionado como administrador de la veterinaria {{$veterinary}} sede {{$city}} en la direccion {{$address}}.
              </p>
							<br>
							<p class="lead"style="text-align:justify;">
              Ahora puedes ingresar y administrar todo lo que corresponde a tu sede veterinaria,  no olvides la siguiente informacion:
              </p>
							<br>
